						    ...
						    <div class="background-blanco pl-3 pr-3 pt-3 pb-3">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <select class="filtro-multiselect">
                                            <option>Venta de Artesanías y Ropa</option>
                                        </select>
                                        </div>
                                    </div>
                                    <div class="borde1 mt-3 mb-3"></div>
                                    <div class="row mb-4">
                                        <div class="col-12 artesanias">
                                        <label class="mb-2">Venta de Artesanías Provenientes de:</label>
                                        <div class="w-100 mb-2">
                                            <button class="boton-artesanias" href="#" onclick="return false;">Arequipa<br></button>
                                            <button class="boton-artesanias" href="#" onclick="return false;">Cusco<br></button>
                                            <button class="boton-artesanias" href="#" onclick="return false;">Ica</button>
                                            <button class="boton-artesanias" href="#" onclick="return false;">Lima</button>
                                            <button class="boton-artesanias" href="#" onclick="return false;">Puno</button>
                                        </div>

                                        <input id="artesanias" type="text" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-12 col-md-6 mb-4">
                                        <label>Venta de Ropa</label>
                                        ...
                                        <select class="filtro-multiselect">
                                            <option>Ropa de Comunidades Andinas o locales</option>
                                            <option>Ropa moderna de diseñadores peruanos</option>
                                            <option>Ropa moderna de diseñadores foráneos</option>
