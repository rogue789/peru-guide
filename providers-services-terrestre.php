					...
					<div class="aD2">
						<div class="aP-30 aBg-blanco aShadow aP-30-20-767">
                            ...
                            <div class="background-blanco pl-3 pr-3 pt-3 pb-3 formulario">
                              <div class="row mb-4">
                                <div class="col-12 col-md-6">
                                  ...
                                  <select class="filtro-multiselect">
                                    <option>Transporte Terreste de Pasajeros</option>
                                  </select>
                                </div>
                              </div>
                              ...
                              <div class="row mb-4">
                                <div class="col-12 terrestre">
                                    <label>Destinos en los que tiene terminal de pasajeros:</label>
                                    <div class="w-100 mb-2">
                                        <button class="boton-terrestre" href="#" onclick="return false;">Arequipa<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Cusco<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Ica<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Lima<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Paracas<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Nasca</button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Cumaná<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Chivay<br></button>
                                        <button class="boton-terrestre" href="#" onclick="return false;">Juliaca<br></button>
                                    </div>
                
                                    <input id="terrestre" type="text" data-role="tagsinput">
                                </div>
                              </div>
                              <div class="row mb-4">  
                                <div class="col-12 servicio-terrestre">
                                    <label>Tipo de servicio ofrecido:</label>
                                    <div class="w-100 mb-2">
                                        <button class="boton-servicio-terrestre" href="#" onclick="return false;">Bus cama<br></button>
                                        <button class="boton-servicio-terrestre" href="#" onclick="return false;">Bus semi-cama<br></button>
                                        <button class="boton-servicio-terrestre" href="#" onclick="return false;">Bus estandar<br></button>
                                       
                                    </div>
                
                                    <input id="servicio-terrestre" type="text" data-role="tagsinput">
                                </div>
                              </div>
                              <div class="row mb-4">
                                <div class="col-12 col-md-6">
                                    <label>Ruta Directa sin paradas:</label>
