			...
			<div class="aNav-servicios">
				<div class="aWrapper">
					<ul class="aTabs aListClean aBdib aBdib-t">
						<li class="active"><a href="accommodations.php">ACCOMMODATIONS</a></li>
				...
				<div class="aTable-t aDb-991">
					...
					<div class="aD1">
						<div class="aD-info aShadow aBg-blanco">
							...
							<div class="aPt-20 aTa-c">
								<a href="" class="aButton-r-a aP-10-23 aFz-16 aFw-600"  data-toggle="modal" data-target="#reservar-tour">Book now</a>
							</div>
						</div>
						<div class="aD-cartel">
					...
					<div class="aD2">
						<ul class="aTabs nav nav-tabs aListClean aTable-m aMb-25 aShadow aDn-767">
							...
							<li><a href="#Ubicación" data-toggle="tab">Ubicación</a></li>
						...
						<div id="" class="aTabcontent aAcordeon-x">
									...
									<div class="aAcontent-x">
										<div class="aD-carousel-contenido aBg-blanco">
											<div class="aCarousel-Contenido">
												<div class="aSlide">
													<img src="img/img-carousel-grande-1.jpg" alt="" title=""/>
												</div>
												<div class="aSlide">
													<img src="img/img-carousel-grande-1.jpg" alt="" title=""/>
												</div>
										...
										<div class="aD-carousel-nav aBg-blanco aTable-m">
											...
											<div class="aCarousel-Nav aCarousel-general">
												<div class="aSlide">
													<img src="img/img-carousel-chico-1.jpg" alt="" title=""/>
												</div>
												<div class="aSlide">
													<img src="img/img-carousel-chico-1.jpg" alt="" title=""/>
												</div>
										...
										<div class="aP-30-35 aBg-blanco aTa-j aP-30-20-767">
											<h3 class="aFz-22 aFc-negro2">Hotel Cardoso</h3>
							...
							<div class="aPanel aShadow tab-pane fade" id="Habitaciones">
								<div class="aAcord-x">
									<a href="#" class="aAtitulo-x">Habitaciones<span class="toggle-icon"></span></a>
									<div class="aAcontent-x">
										<div class="aP-30-35 aBg-blanco aP-30-20-767">
											...
											<div class="aBdib-m aMt-20 aMb-25">
												<div class="aA-160 aPr-10 aMt-10 aW-100-767 aP-0-767">
													<p>Check In</p>
													<input class="aDate aI-fecha" type="text" placeholder="mm/dd/yyyy">
												</div>
												<div class="aA-160 aPl-10 aPr-10 aMt-10 aW-100-767 aP-0-767">
													<p>Check Out</p>
													<input class="aDate aI-fecha" type="text" placeholder="mm/dd/yyyy">
												</div>
												<div class="aA-160 aPl-10 aMt-10 aW-100-767 aP-0-767">
													<p class="aDn-767">&nbsp;</p>
													<input class="aButton-r-a" type="submit" value="New Search">
												</div>
											</div>
											<div class="aAcordeon aAcordeon-precio">

											  <div class="aAcord aMb-20">
											    <a href="#" class="aAtitulo open">Simple Room <strong>(1 twin size bed)</strong><span class="aPrice">USD 200.00 per night</span><span class="toggle-icon"></span></a>
											    <div class="aAcontent aOp">
											      <div class="aDiv aTable-m aDb-767">
											      	<div class="aPr-10 aPr-0-767 aDb-767 aMb-10-767"><p>2 Simple Rooms Available  -  <strong>June 19, 2017</strong></p></div>
											      	<div class="aA-110 aDb-767 aM-x-auto-767"><a href="" class="aBpopup aButton-g-r aP-10 aFz-16 aTa-c">Book now</a></div>
											      </div>
											      <div class="aDiv aTable-m aDb-767">
											      	<div class="aPr-10 aPr-0-767 aDb-767 aMb-10-767"><p>1 Bed Available  -  <strong>June 20, 2017</strong></p></div>
											      	<div class="aA-110 aDb-767 aM-x-auto-767"><a href="" class="aBpopup aButton-g-r aP-10 aFz-16 aTa-c">Book now</a></div>
											      </div>
											    </div>  
											  </div>
											  ...
											  <div class="aAcord aMb-20">
											    <a href="#" class="aAtitulo">Simple Superior Room with view<strong>(1 queen size bed)</strong><span class="aPrice">USD 200.00 per night</span><span class="toggle-icon"></span></a>
											    <div class="aAcontent">
											      <div class="aDiv aTable-m aDb-767">
											      	<div class="aPr-10 aPr-0-767 aDb-767 aMb-10-767"><p>2 Simple Rooms Available  -  <strong>June 19, 2017</strong></p></div>
											      	<div class="aA-110 aDb-767 aM-x-auto-767"><a href="" class="aBpopup aButton-g-r aP-10 aFz-16 aTa-c">Book now</a></div>
											  ...
											  <div class="aAcord aMb-20">
											    ...
											    <div class="aAcontent">
											      ...
											      <div class="aDiv aTable-m aDb-767">
											      	<div class="aPr-10 aPr-0-767 aDb-767 aMb-10-767"><p>Double Superior Room   -  <strong>(2 queen size beds)</strong></p></div>
											      	<div class="aA-110 aDb-767 aM-x-auto-767"><a href="" class="aBpopup aButton-g-r aP-10 aFz-16 aTa-c">Book now</a></div>
											      </div>
											    </div>
											  </div>
							...
							<div class="aPanel aShadow tab-pane fade" id="Ubicación">
								<div class="aAcord-x">
							...
							<div class="aPanel aShadow tab-pane fade" id="Servicios">
								<div class="aAcord-x">
									<a href="#" class="aAtitulo-x">Servicios<span class="toggle-icon"></span></a>
									<div class="aAcontent-x">
										<div class="aP-30-35 aBg-blanco aTa-j aP-30-20-767">
											<h3 class="aFz-22 aFc-negro2">Hotel Cardoso</h3>
											<div class="aA-55 aH-2 aBg-rojo aMt-20 aMb-20"></div>
											<p><strong>Acerca de este establecimiento :</strong>Frente al mar, Acceso para sillas de ruedas, Hotel para no fumadores.</p>
											<p><strong>Cosas que hacer :</strong> Piscina, Gimnasio, Sala de entrenamiento, Restaurante, Bar / Salón, Spa, Casino y juegos de azar, Bañera de hidromasaje</p>
											<p><strong>Tipos de habitación :</strong>Habitaciones para no fumadores, Suites, Habitaciones para familias.</p>
											<p><strong>Internet :</strong>Wi-Fi con cargo adicional, Internet con cargo adicional, Internet gratis, Internet de alta velocidad gratuito (WiFi).</p>
											<p><strong>Servicios :</strong>Servicio de habitación, Centro de negocios con acceso a Internet, Transporte desde / al aeropuerto, Limpieza en seco, Salas de reuniones, Servicio de lavandería, Conserje, Salón de banquetes, Personal multilingüe, Salas de conferencias, Guardería.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="aAcord-x">
									...
									<div class="aAcontent-x">
										<div class="aP-30-35 aBg-blanco aTa-j aP-30-20-767">
											...
											<div class="aBg-gris1 aB-gris aP-30-45 aTable-m aP-30-20-767">
