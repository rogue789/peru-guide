...
<body>
	...
	<section class="aPinterna aPage-providers-section aPage-providers-perfil formulario">
		...
		<div class="aDiv-Banner aDiv-Banner-2" style="background: rgba(0, 0, 0, 0) url('img/banner-seccion-operador.jpg') no-repeat scroll center center / cover">
			<div class="aWrapper">
				<h3 class="aFz-34 aFc-blanco aTa-ci aMb-0">My Profile</h3>
			</div>
		</div>
                                ...
                                <form id="fileupload" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <select class="filtro-multiselect">
                                            <option>Transporte Aéreo de Pasajeros</option>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 aereo">
                                            <label>Destinos en los que tiene terminal aèreo:</label>
                                            <div class="w-100 mb-2">
                                                <button class="boton-aereo" href="#" onclick="return false;">Arequipa<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Cusco<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">pisco<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Lima<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Puerto Maldonado<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Piura</button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Tumbes<br></button>
                                                <button class="boton-aereo" href="#" onclick="return false;">Juliaca<br></button>
                                            </div>
                        
                                            <input id="aereo" type="text" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-12 aerolinea">
                                            <label>Tipo de aerolinea:</label>
                                            <div class="w-100 mb-2">
                                                <button class="boton-aerolinea" href="#" onclick="return false;">Low Cost<br></button>
                                                <button class="boton-aerolinea" href="#" onclick="return false;">Servicio Estándar<br></button>
                                            
                                            </div>
                        
                                            <input id="aerolinea" type="text" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-12 col-md-6">
